// After publishing on GitHub, set your username and repo name here (one place).
window.PTAN_SITE_CONFIG = {
  ...
  extensionCrx: "assets/PTagNewLineSupportExtension.crx",
  extensionCrxDownloadName: "PTagNewLineSupportExtension.crx",
